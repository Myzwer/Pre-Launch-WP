<?php
	 ...
	 *
	 * Notes:
	 *  - Brand colors are loaded from the shared PHP token helper.
	 *  - Keep PHP tokens aligned with frontend Tailwind tokens.
	 ...
	 * ------------------------------------------------------------------------
	 *
	 * Pull shared brand colors from the theme token helper so editor palette
	 * values stay aligned with other WordPress-driven UI contexts.
	 */
	$brand_colors = prelaunch_get_brand_colors();
