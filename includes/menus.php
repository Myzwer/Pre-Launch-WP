...
{
    register_nav_menus([
        // Main site navigation (custom nav walker).
        'primary-nav' => __('Primary Navigation', 'windpeak'),

        // Footer link groups (used by the current footer template).
        'footer-column-1' => __('Footer Links 1', 'windpeak'),
        'footer-column-2' => __('Footer Links 2', 'windpeak'),
    ]);
}
